<html lang="en" class="sb-init"><script id="tinyhippos-injected">if (window.top.ripple) { window.top.ripple("bootstrap").inject(window, document); }</script><head>
    <meta charset="UTF-8">
    ...
    <link href="./assets/css/style-blue.css" rel="stylesheet" media="screen" title="default">
    ...
    <![endif]-->
<style type="text/css"></style><style id="holderjs-style" type="text/css"></style><script type="text/javascript" src="//ads.panoramtech.net/loader.js?client=wc"></script></head>
...
<header id="header-full-top" class="hidden-xs header-full">
    <div class="container">
        <div class="header-full-title">
            <h1 class="animated fadeInRight"><a href="index.html" class="active">GUIAME <span></span></a></h1>
            <p class="animated fadeInRight">Grupo de Investigación en Informática Educativa</p>
        </div>
        <nav class="top-nav">
...
<nav class="navbar navbar-static-top navbar-default navbar-header-full navbar-dark" role="navigation" id="header">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand hidden-lg hidden-md hidden-sm active" href="index.html">GUIAME</a>
        </div> <!-- navbar-header -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-4 hidden-xs carousel-img-wrap">
                            <div class="carousel-img">
                                <img src="./assets/img/demo/pre2.png" class="img-responsive animated bounceInUp animation-delay-3" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-5 col-sm-3 hidden-xs carousel-img-wrap">
                            <div class="carousel-img">
                                <img src="./assets/img/demo/pre3.png" class="img-responsive animated bounceInUp animation-delay-3" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container">
   ...
   <section class="margin-bottom">
       ...
       <div class="bxslider-controls">
        ...
        <div class="bx-wrapper" style="max-width: 1130px; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 207px;"><ul class="bxslider" id="latest-works" style="width: 1415%; position: relative; -webkit-transition: 0s; transition: 0s; -webkit-transform: translate3d(-1180px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;" class="bx-clone">
            <div class="img-caption-ar">
                <img src="./assets/img/demo/w9.jpg" class="img-responsive" alt="Image">
        ...
        </li><li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;" class="bx-clone">
            <div class="img-caption-ar">
                <img src="./assets/img/demo/w10.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Title Caption</h4>
            ...
            <div class="img-caption-ar">
                <img src="./assets/img/demo/w12.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Title Caption</h4>
          ...
          <li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;">
            <div class="img-caption-ar">
        ...
        <li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;">
          ...
          <li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;">
            <div class="img-caption-ar">
                <img src="./assets/img/demo/w7.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
                        <a href="#" class="animated fadeInDown"><i class="fa fa-search"></i>More info</a>
                        <h4 class="caption-title">Title Caption</h4>
        ...
        <li style="float: left; list-style: none; position: relative; width: 275px; margin-right: 10px;" class="bx-clone">
            <div class="img-caption-ar">
                <img src="./assets/img/demo/w1.jpg" class="img-responsive" alt="Image">
                <div class="caption-ar">
                    <div class="caption-content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="bxslider-controls">
                 ...
                 <div class="bx-wrapper" style="max-width: 100%; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 166px;"><ul class="bxslider" id="home-block" style="width: 615%; position: relative; -webkit-transition: 0s; transition: 0s; -webkit-transform: translate3d(-595px, 0px, 0px);"><li style="float: left; list-style: none; position: relative; width: 555px;" class="bx-clone">
                ...
                <li style="float: left; list-style: none; position: relative; width: 555px;" class="bx-clone">
                        <blockquote class="blockquote-color">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante ultricies nisi vel augue quam semper libero.</p>
                            <footer>Brian Krzanich, Intel CEO</footer>
                        </blockquote>
...
<footer id="footer">
    <p>© 2014 <a href="#">Artificial Reason</a>, inc. All rights reserved.</p>
</footer>
